 ...
 */
 (function (global, factory) {
    ...
    function getComponentName(type) {
...

        {
            if (typeof type.tag === 'number') {
                error('Received an unexpected object in getComponentName(). ' +
    ...
    function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
        ...
        if (Array.isArray(children)) {
            ...
            if (typeof iteratorFn === 'function') {
                ...
                {
                    {
                        throw Error("Objects are not valid as a React child (found: " + (childrenString ===
                ...
                if (payload._status === Pending) {
...

                    {
                        if (defaultExport === undefined) {
                            error('lazy: Expected the result of a dynamic import() call. ' +
    ...
    function isValidElementType(type) {
        ...
        if (type === exports.Fragment || type === exports.Profiler || type ===
            REACT_DEBUG_TRACING_MODE_TYPE || type === exports.StrictMode || type === exports.Suspense ||
            type === REACT_SUSPENSE_LIST_TYPE || type === REACT_LEGACY_HIDDEN_TYPE || enableScopeAPI) {
            return true;
        }
        ...
        if (typeof type === 'object' && type !== null) {
            if (type.$$typeof === REACT_LAZY_TYPE || type.$$typeof === REACT_MEMO_TYPE || type.$$typeof ===
                ...
                REACT_FORWARD_REF_TYPE || type.$$typeof === REACT_FUNDAMENTAL_TYPE || type.$$typeof ===
                REACT_BLOCK_TYPE || type[0] === REACT_SERVER_BLOCK_TYPE) {
                return true;
            }
        }
    ...
    function useContext(Context, unstable_observedBits) {
...

        {
            if (unstable_observedBits !== undefined) {
                error('useContext() second argument is reserved for future ' +
